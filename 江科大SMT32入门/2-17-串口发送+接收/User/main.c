...
uint8_t RxData;
uint8_t A[] = {0x55 ,0x55 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0xFF ,0x03 ,0xFD ,0xD4 ,0x14 ,0x01 ,0x17 ,0x00};
uint8_t B[] = {0x00 ,0x00 ,0xFF ,0x04 ,0xFC ,0xD4 ,0x4A ,0x01 ,0x00 ,0xE1 ,0x00};


int main (void)
{
	OLED_Init();
	OLED_ShowString(1, 1, "USART RxData:" );
	SerialPort_Init();
...
//		}
		...
		{
			RxData = Serial_GerRxData();
			SerialPort_SendByte(RxData);
			OLED_ShowHexNum(2, 1, RxData, 2);
		}
	}
}
