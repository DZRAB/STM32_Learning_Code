...
int main (void)
{
	OLED_Init();
	Key_Init();
	OLED_ShowString(1, 1, "BKP_W:" );
	OLED_ShowString(2, 1, "BKP_R:" );
	...
	while(1)
	{
		...
		if(KeyNum == 1)
		{
			...
			OLED_ShowHexNum(1, 7, ArrayWrite[0], 4);
			OLED_ShowHexNum(1, 12, ArrayWrite[1], 4);
		}
		ArrayRead[0] = BKP_ReadBackupRegister(BKP_DR1);
		ArrayRead[1] = BKP_ReadBackupRegister(BKP_DR2);
		OLED_ShowHexNum(2, 7, ArrayRead[0], 4);
		OLED_ShowHexNum(2, 12, ArrayRead[1], 4);
