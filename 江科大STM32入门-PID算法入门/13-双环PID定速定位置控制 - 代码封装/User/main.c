...
//			
//		OLED_Printf(0,2*8,OLED_8X16,"Kp:%4.2f",Inner.Kp);
//		OLED_Printf(0,4*8,OLED_8X16,"Ki:%4.2f",Inner.Ki);
//		OLED_Printf(0,6*8,OLED_8X16,"Kd:%4.2f",Inner.Kd);
//		
//		OLED_Printf(64,2*8,OLED_8X16,"Tar:%+04.0f",Inner.Target);
//		OLED_Printf(64,4*8,OLED_8X16,"Act:%+04.0f",Inner.Actual);
//		OLED_Printf(64,6*8,OLED_8X16,"Out:%+04.0f",Inner.Out);
//		
//		OLED_Update();		
...
//		Outer.Kd = RP_GetValue(3)/4095.0*2;
		...
		OLED_Printf(0,2*8,OLED_8X16,"Kp:%4.2f",Outer.Kp);
		OLED_Printf(0,4*8,OLED_8X16,"Ki:%4.2f",Outer.Ki);
		OLED_Printf(0,6*8,OLED_8X16,"Kd:%4.2f",Outer.Kd);
		
		OLED_Printf(64,2*8,OLED_8X16,"Tar:%+04.0f",Outer.Target);
		OLED_Printf(64,4*8,OLED_8X16,"Act:%+04.0f",Outer.Actual);
		OLED_Printf(64,6*8,OLED_8X16,"Out:%+04.0f",Outer.Out);
